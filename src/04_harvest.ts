...
import { harvestPositionInstructions, setNativeMintWrappingStrategy } from "@orca-so/whirlpools";
...
async function main() {
  ...
  const { feesQuote, rewardsQuote, instructions: harvestIxs } = await harvestPositionInstructions(
    kitRpc,
